...
RcppExport SEXP _SNPoSOM_calculateDelta(SEXP inputMatrixSEXP, SEXP inputVectorSEXP, SEXP naExistSEXP, SEXP resultDeltaSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _SNPoSOM_calculateEuclideanDistances(SEXP deltaMatrixSEXP, SEXP resultEuclideanDistances2SEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SNPoSOM_calculateNeighborhoodMatrix(SEXP winnerNeuronRSEXP, SEXP somSizeSEXP, SEXP radiusSEXP, SEXP resultVectorSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SNPoSOM_matrixToCodebookMatrix(SEXP matrixAsVectorSEXP, SEXP resultSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_SNPoSOM_calculateDelta", (DL_FUNC) &_SNPoSOM_calculateDelta, 4},
    {"_SNPoSOM_calculateEuclideanDistances", (DL_FUNC) &_SNPoSOM_calculateEuclideanDistances, 2},
    {"_SNPoSOM_calculateNeighborhoodMatrix", (DL_FUNC) &_SNPoSOM_calculateNeighborhoodMatrix, 4},
    {"_SNPoSOM_matrixToCodebookMatrix", (DL_FUNC) &_SNPoSOM_matrixToCodebookMatrix, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_SNPoSOM(DllInfo *dll) {
